...
export const greetings = {
  ...
  `,
  hobbyDescription:
    "Outside of my programming life, I enjoy quite a few things.  Some of which include:",
  hobbies: [
    "Playing video games",
    "Playing Magic the Gathering with friends",
    "Reading light novels, mangas, manhwas, and webtoon stories",
    "Watching anime",
  ],
  resumeLink:
    "https://docs.google.com/document/d/1h0SMBwCqSyXQGZwGP-cYTgwHwOACZm3KPu6PGtOVulM/export?format=pdf",
};
...
export const skillsSection = {
  title: "Skills",
  subTitle:
    "Here are some technologies and tools that I am familiar with or have used",
  skills: [
    emoji(
    ...
    emoji(
      "⚡ Make requests from front end to back end via REST and / or GraphQL"
    ),
    emoji("⚡ Integration of third party services such as AWS / Cloudinary"),
  ],
...
export const experience = [
  {
    ...
    desc: "Working as a team to build out an Express plus React app allowing landowners to list their property for rent and users to make reservations on those listings",
    descBullets: [
...
export const projects = [
  {
    name: "League Stats",
    desc: "Full stack app utilizing Riot’s API to grab user data in popular MMO League of Legends.  Inspired by OP.GG, U.GG, and League of Graphs.",
    link: {
      name: "Visit",
      url: "https://league-stats-front.herokuapp.com/",
    },
  },
  {
    name: "Instantelegram",
    desc: "Media sharing platform inspired by Instagram.",
    link: {
      name: "Visit",
      url: "https://instantelegram-aa.herokuapp.com",
    },
  },
  {
    name: "QWERTY Shop",
